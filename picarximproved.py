...
class Picarx(object):
    ...
    @log_on_end(logging.DEBUG, "Inititilized")
    def __init__(self, 
    ...
    def set_motor_speed(self,motor,speed):
        @log_on_start(logging.DEBUG , "starting motor functions  ")
        @log_on_error(logging.DEBUG , "check them motors fam ")
        @log_on_end(logging.DEBUG , "motros all set  ")
    ...
    def motor_speed_calibration(self,value):
        # global cali_speed_value,cali_dir_value
        log_on_start(logging.DEBUG, "motor calibration...")
    ...
    def motor_direction_calibration(self,motor, value):
        @log_on_start(logging.DEBUG , "starting motor speed  ")
        @log_on_error(logging.DEBUG , "check them motor speed claibration ")
        @log_on_end(logging.DEBUG , "motros all set  ")
    ...
    def dir_servo_angle_calibration(self,value):
        @log_on_error(logging.DEBUG , "motor angle ")
        self.dir_cal_value = value
        self.config_flie.set("picarx_dir_servo", "%s"%value)
        self.dir_servo_pin.angle(value)

    def set_dir_servo_angle(self,value):
        @log_on_error(logging.DEBUG , "check motor direction and angle ")
        self.dir_current_angle = value
        angle_value  = value + self.dir_cal_value
        self.dir_servo_pin.angle(angle_value)

    def camera_servo1_angle_calibration(self,value):
        @log_on_error(logging.DEBUG , "servo 1 ")
        self.cam_cal_value_1 = value
        self.config_flie.set("picarx_cam_servo1", "%s"%value)
        self.camera_servo_pin1.angle(value)

    def camera_servo2_angle_calibration(self,value):
        @log_on_error(logging.DEBUG , "servo 2")
